...
from app.utilities.config_utils import *
...
numTilings = get_num_tilings()
alpha = 0.1 / get_num_tilings() # step size
epsilon_0 = get_epsilon0()
epsilon = epsilon_0
gamma = get_gamma()
lambda_ = get_lambda()
num_Episodes = 300
...
for episode in range(num_Episodes):
    ...
    state, info = env.reset(seed=get_seed() + episode)
